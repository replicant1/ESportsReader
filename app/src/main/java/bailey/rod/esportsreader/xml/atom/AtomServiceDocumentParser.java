...
public class AtomServiceDocumentParser {
     ...
     */
    public AtomServiceDocument parse(InputStream istream, String url, String etag, long lastModified)
        ...
        try {
            ...
            return parseService(parser, url, etag, lastModified);
        } finally {
     ...
     */
    private AtomServiceDocument parseService(XmlPullParser parser, String url, String etag, long lastModified)
            throws XmlPullParserException, IOException {
        ...
        return new AtomServiceDocument(workspaceTitle, collectionList, url, etag, lastModified);
    }
